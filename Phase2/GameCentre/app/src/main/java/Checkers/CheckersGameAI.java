...
//     */
//    int[][] getTakeMove(CheckersBoardManager checkersBoardManager, int row, int column) {
//        int[][] move = NO_LEGAL_MOVE;
//        CheckersTile[][] tiles = checkersBoardManager.getBoard().tiles;
//        String selectedTileId = tiles[row][column].getCheckersId();
//        if (selectedTileId.contains("red") && !selectedTileId.contains("king")){
//        //TODO fix this
//        }
//        else {
//        return move;
